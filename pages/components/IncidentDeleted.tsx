    ...
    const [errorMessage, setErrorMessage] = useState<string|null>();
      ...
      function submit(){
        ...
        const requestOptions = {
          ...
          body: JSON.stringify({ 
            query:` mutation{
              deleteIncident(incidents: {_id:"${value.incidentToDelete?._id}"}){
               _id
              }
            }`
          })
        ...
        fetch('http://localhost:4000/graphql', requestOptions)
            ...
            .then(data=>value.setIncidentDeleted(true))
    ...
    return(
        <Bg >
            <Modal>
                ...
                <i onClick={()=>value.setIncidentToDelete(null)}className="fa-solid fa-xmark x fa-lg" ></i>
                {!confirmed && 
                    <div> 
