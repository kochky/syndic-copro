...
export const ReleveDelete = ({yearSelected,deleteReleve,setReleveCreated,setDeleteReleve}:Props) => {
    ...
    return(
        <Bg >
            <Modal>
                <Title> Suppression relevé</Title>
                ...
                <div> { confirmed && <Alert severity="success">Relevé supprimé!</Alert>}
