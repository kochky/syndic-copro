...
export const IncidentCreate = ({setCreateIncident}:Props) => {
    ...
    const [description, setDescription] = useState('');
      ...
      function submit(){
        ...
        setConfirmed(false)
        const date=new Date()
        const dateToPost=date.getDate()+'/'+date.getMonth()+"/"+date.getFullYear()
    ...
    return(
        <Bg >
            <Modal>
                ...
                <i onClick={()=>setCreateIncident(false)}className="fa-solid fa-xmark x fa-lg" ></i>
               {!confirmed && <InputContainer>
                ...
                <div> { confirmed && <Alert severity="success">L&apos;incident a été remonté et sera examiné!</Alert>}
