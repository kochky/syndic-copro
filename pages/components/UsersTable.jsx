...
function stableSort(array, comparator) {
  ...
  export default function UsersTable() {
    ...
    useEffect(() => {
        ...
        .then(r=>context.setNewUserCreated(false))
        .catch(error=>console.log(error))
  }, [context.newUserCreated])
  
    function handleModifyUser(_id,name,email,lot,millieme){
        context.setUserToModify({_id:_id,name:name,email:email,lot:lot,millieme:millieme})
    }
    function handleDeleteUser(_id){
      context.setUserToDelete({_id:_id})
  }
                  ...
                  .map((row, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell onClick={()=>handleModifyUser(row._id,row.name,row.email,row.lot,row.millieme)} align="left"><i className="fa-solid fa-user-pen"></i></TableCell>
                        <TableCell onClick={()=>handleDeleteUser(row._id)} align="left"><i className="fa-solid fa-user-slash"></i></TableCell>
