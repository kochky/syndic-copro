        ...
        <Menu>
           {value.windowSize >768 ?<><Title onClick={()=>router.push('/')}><i className="fa-solid fa-arrow-left"></i>&nbsp;Ma Copro&apos;</Title>
            <SecondTitle>Menu <BasicMenu/> </SecondTitle>
                <List>
                    ...
                    {!value.activeMessage ? <Item onClick={()=>handleActive('message')}> <Badge anchorOrigin={{ vertical: 'top', horizontal: 'left', }} badgeContent={msg.newMessage} color="success" > <MailOutlineIcon color='action' /></Badge> &nbsp;Messagerie </Item>: <Item active={true}><Badge anchorOrigin={{ vertical: 'top', horizontal: 'left', }} color="success" badgeContent={msg.newMessage}className="non-active" > <MailOutlineIcon  /></Badge> &nbsp;Messagerie</Item>}
           ...
           <div style={{display:"flex",justifyContent:"center"}}>
                <List>   
                    ...
                    {!value.activeMessage ? <Item onClick={()=>handleActive('message')}>  <Badge anchorOrigin={{ vertical: 'top', horizontal: 'left', }} badgeContent={msg.newMessage} color="success" > <MailOutlineIcon color='action' /></Badge> </Item>: <Item active={true}> <Badge anchorOrigin={{ vertical: 'top', horizontal: 'left', }} color="success" badgeContent={msg.newMessage}className="non-active" > <MailOutlineIcon  /></Badge></Item>}
